...
import Business.Organization.Organization.StemCellBankType;
...
import static Business.Enterprise.Enterprise.EnterpriseType.StemCellBank;
...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
       ...
       System.out.println(enterprise.getEnterpriseType().toString().equals(StemCellBank.toString()));
       ...
       else if(enterprise.getEnterpriseType().toString().equals(StemCellBank.toString())){
        for(Organization.StemCellBankType bmType: Organization.StemCellBankType.values()){
            add = true;
            System.out.println(bmType.getValue());
            System.out.println(Organization.StemCellBankType.StemCellBank.getValue());
            if (bmType.getValue().equals(Organization.StemCellBankType.StemCellBank.getValue())){
                for (Organization organization : directory.getOrganizationList()) {
    ...
    private void initComponents() {
        ...
        add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, 390, 480));
        ...
        add(lblEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 90, -1, -1));
        ...
        add(txtEnterpriseName, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, 240, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 460, 270));
...
// Main Process after validation checks
        ...
        if(enterprise.getEnterpriseType().toString().equals(Legal.toString())){
            ...
            directory.createStemCellOrganization((StemCellBankType)cmbOrganizationType.getSelectedItem(), txtOrganizationName.getText());
        }
        else if(enterprise.getEnterpriseType().toString().equals(BloodCancerCentre.toString())){
