...
import userinterface.StemCellBankCoordinatorRole.ManageStemCellBankCoordinatorProfile;
import userinterface.Stem_Cell_Bank_CoordinatorRole.StemCellRequestJPanel;
...
public class StemCellBankCoordinatorWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form StemCellBankCoordinatorWorkAreaJPanel
     */
    boolean a = true;
    ...
    public StemCellBankCoordinatorWorkAreaJPanel(UserAccount account, Stem_Cell_Bank_Organization bmBankOrganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
    ...
    private void BtnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnProfileMouseClicked
        ...
        ManageStemCellBankCoordinatorProfile managebmBankProfile = new ManageStemCellBankCoordinatorProfile(userAccount,bmBankOrganization,enterprise);
        userProcessContainer.add("ManageStemCellBankCoordinatorProfile",managebmBankProfile);
    ...
    private void BtnManageRequestsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnManageRequestsMouseClicked
        // TODO add your handling code here:
        StemCellRequestJPanel bmBankRequestJPanel = new StemCellRequestJPanel( userAccount,  bmBankOrganization, enterprise, network, system);
        userProcessContainer.add("StemCellRequestJPanel",bmBankRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer); 
