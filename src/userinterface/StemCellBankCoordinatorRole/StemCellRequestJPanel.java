 ...
 */
package userinterface.Stem_Cell_Bank_CoordinatorRole;
 ...
 * @author Payal
 */
public class StemCellRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form StemCellRequestJPanel
     */
    private UserAccount userAccount;
    private Stem_Cell_Bank_Organization marroworganization;
    private Enterprise enterprise;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    private EcoSystem system;
    
    public StemCellRequestJPanel(UserAccount userAccount, Stem_Cell_Bank_Organization bmBankOrganization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
        ...
        tblStemCellCoordinator.getTableHeader().setDefaultRenderer(new MyTableFormat());
        tblHLAAvailability.getTableHeader().setDefaultRenderer(new MyTableFormat());
        
        
        populateStemCellCoordinatorTable();
    ...
    public void populateStemCellCoordinatorTable(){
        DefaultTableModel model = (DefaultTableModel)tblStemCellCoordinator.getModel();
    ...
    private void initComponents() {
        ...
        tblStemCellCoordinator = new javax.swing.JTable();
        ...
        lblListOfBoneMarrowRequests.setForeground(new java.awt.Color(255, 255, 255));
        lblListOfBoneMarrowRequests.setText("List of StemCell Requests");
        ...
        btnApprove.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        ...
        btnOnHold.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        ...
        tblStemCellCoordinator.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        tblStemCellCoordinator.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblStemCellCoordinator.setGridColor(new java.awt.Color(0, 0, 0));
        tblStemCellCoordinator.setRowHeight(30);
        tblStemCellCoordinator.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblStemCellCoordinatorMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblStemCellCoordinator);
        ...
        lblBoneMarrowBank.setText("Stem Cell Bank");
        ...
        lblBoneMarrowInventory.setForeground(new java.awt.Color(255, 255, 255));
        lblBoneMarrowInventory.setText("StemCell Inventory");
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        int selectedRow = tblStemCellCoordinator.getSelectedRow();
        ...
        if (selectedRow < 0){
            ...
            WorkRequest request = (WorkRequest)tblStemCellCoordinator.getValueAt(selectedRow, 0);
            if(request.getStatus().equals("Legally Approved. Passing to StemCellBank")
                || request.getStatus().equals("On Hold Due to StemCell unavailability")){
                ...
                if (org != null) {
                    request.setStatus("StemCellBank Approved. Passing to System Coordinator");
    ...
    private void btnOnHoldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOnHoldActionPerformed
        ...
        if (selectedRow < 0){
            ...
            WorkRequest request = (WorkRequest)tblStemCellCoordinator.getValueAt(selectedRow, 0);
            if(request.getStatus().equals("Legally Approved. Passing to StemCellBank")){
                request.setStatus("On Hold Due to StemCell unavailability");
    ...
    private void tblStemCellCoordinatorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblStemCellCoordinatorMouseClicked
        // TODO add your handling code here:
        ...
        if (selectedRow < 0){   
            ...
            if(request.getStatus().equals("Legally Approved. Passing to StemCellBank")){
                ...
                if(request.getPatient().isEmergencyStatus() == true){
                    JOptionPane.showMessageDialog(null, new JLabel("Legally Approved. Passing to StemCellBank"), "Warning", JOptionPane.WARNING_MESSAGE);
                }
                //dB4OUtil.storeSystem(system);
                //populateStemCellCoordinatorTable();   
            }
...
//                 jPanel1.setVisible(false);
    ...
    }//GEN-LAST:event_tblStemCellCoordinatorMouseClicked
    ...
    private javax.swing.JTable tblStemCellCoordinator;
