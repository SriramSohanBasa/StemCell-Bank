...
public class ManageSystemCoordinatorProfile extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, -1, -1));
        ...
        add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, -1));

        lblCity.setBackground(new java.awt.Color(255, 255, 255));
        lblCity.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblCity.setForeground(new java.awt.Color(255, 255, 255));
        lblCity.setText("City:");
        add(lblCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, -1, -1));
        ...
        add(lblState, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, -1, -1));
        ...
        add(lblGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 80, -1, -1));
        ...
        lblDOB.setText("DOB:");
        add(lblDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 120, -1, -1));
        ...
        add(txtCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 146, -1));

        txtState.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(txtState, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 40, 146, -1));

        txtSpecialization.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(txtSpecialization, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 150, 146, -1));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, -1, -1));

        cmbGender.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        cmbGender.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Male", "Female" }));
        add(cmbGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 70, -1, -1));

        lblSpecialization.setBackground(new java.awt.Color(255, 255, 255));
        ...
        add(lblSpecialization, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 150, -1, -1));
        ...
        add(txtDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 110, 150, -1));
