...
public class OrganizationDirectory {
    ...
    public Organization createLegalOrganization(Organization.LegalType legalType, String realName){
     ...
     public Organization createStemCellOrganization(Organization.StemCellBankType scBankType, String realName){
        Organization organization = null;
        if (scBankType.getValue().equals(Organization.StemCellBankType.StemCellBank.getValue())){
            organization = new Stem_Cell_Bank_Organization();
            organization.setRealName(realName);
            organizationList.add(organization);
        }
        return organization;
